...
// 2번 이상 5번 미만 추출
var sliced = foods.slice(2, 5);     // 2번부터 5번 미만까지 잘라서 새로 추가
console.log(sliced);
console.log(foods);
...
var copyNums = nums.slice(0);           // slice로 카피뜨고 reverse하기 
copyNums.reverse();
...
var result = foods.includes('닭꼬치');      // 있으면 true
console.log(result);
